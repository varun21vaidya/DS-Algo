...
<pre style="position: relative;"><strong>Input:</strong> root = [3,5,1,6,2,0,8,null,null,7,4], target = 5, k = 2
...
<pre style="position: relative;"><strong>Input:</strong> root = [1], target = 1, k = 3
