...
<pre style="position: relative;"><strong>Input:</strong> buildings = [[2,9,10],[3,7,15],[5,12,12],[15,20,10],[19,24,8]]
...
<pre style="position: relative;"><strong>Input:</strong> buildings = [[0,2,3],[2,5,3]]
