...
<pre style="position: relative;"><strong>Input:</strong> n = 1, k = 6, target = 3
...
<pre style="position: relative;"><strong>Input:</strong> n = 2, k = 6, target = 7
...
<pre style="position: relative;"><strong>Input:</strong> n = 30, k = 30, target = 500
