...
<pre style="position: relative;"><strong>Input:</strong> target = 1, startFuel = 1, stations = []
...
<pre style="position: relative;"><strong>Input:</strong> target = 100, startFuel = 1, stations = [[10,100]]
...
<pre style="position: relative;"><strong>Input:</strong> target = 100, startFuel = 10, stations = [[10,60],[20,30],[30,30],[60,40]]
