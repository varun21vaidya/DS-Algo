...
<pre style="position: relative;"><strong>Input:</strong> n = 5, minProfit = 3, group = [2,2], profit = [2,3]
...
In total, there are 2 schemes.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> n = 10, minProfit = 5, group = [2,3,5], profit = [6,7,8]
...
There are 7 possible schemes: (0), (1), (2), (0,1), (0,2), (1,2), and (0,1,2).<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>
